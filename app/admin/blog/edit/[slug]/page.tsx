    ...
    try {
      ...
      if (response.ok) {
        setFormData({
          ...
          category: data.category || 'Yapay Zeka',
          author: data.author || 'FOKUS İstatistik',
          readTime: data.readTime || '5 dakika okuma',
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <p className="text-xs text-amber-600 mt-1">
                        ⚠️ Slug değiştirmek mevcut bağlantıları bozabilir
                      </p>
                    </div>
