    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#860000] to-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Blog Yönetim Sistemi</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#860000] text-white py-3 px-4 rounded-lg font-semibold hover:bg-[#a30000] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#860000] transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-center text-sm text-gray-600">
              © 2025 FOKUS İstatistik. Tüm hakları saklıdır.
            </p>
          </div>
        </div>
      </div>
