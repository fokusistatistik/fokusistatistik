      ...
      <style jsx global>{`
        * {
        ...
        .kvz-voice-btn {
          ...
          justify-content: center;
          transition: all 0.3s ease;
          animation: kvz-pulse 3s infinite;
        }
      ...
      <div className="kvz-page">
        ...
        <div className="kvz-container">
          <div className="kvz-header">
            ...
            <div className="kvz-company-name">{getText('FOKUS İstatistik', 'FOKUS Statistics')}</div>
            <div className="kvz-tagline">{getText('Veri Bilimi & Yapay Zeka Danışmanlığı', 'Data Science & AI Consulting')}</div>
          </div>
          ...
          <div className="kvz-content">
            ...
            <a href="https://asistan.fokusistatistik.com/" className="kvz-ecosystem-btn" target="_blank" rel="noopener noreferrer">
            ...
            <div className="kvz-section">
              <div className="kvz-assistants-grid">
                {[
                  { code: 'fokus001', name: getText('Yönetici Asistanı', 'Manager Assistant'), img: 'https://static.fokusistatistik.com/asistanlar/fokus001.png' },
                  { code: 'fokus216', name: getText('Müşteri Hizmetleri', 'Customer Service'), img: 'https://static.fokusistatistik.com/asistanlar/fokus216.png' },
                  { code: 'fokus314', name: getText('Veri Analisti', 'Data Analyst'), img: 'https://static.fokusistatistik.com/asistanlar/fokus314.png' },
                  { code: 'fokus520', name: getText('Pazarlama & Lead', 'Marketing & Lead'), img: 'https://static.fokusistatistik.com/asistanlar/fokus520.png' },
                  { code: 'fokus618', name: getText('Finans & Fatura', 'Finance & Invoice'), img: 'https://static.fokusistatistik.com/asistanlar/fokus618.png' },
                  { code: 'fokus707', name: getText('İnsan Kaynakları', 'Human Resources'), img: 'https://static.fokusistatistik.com/asistanlar/fokus707.png' },
                  { code: 'fokus717', name: getText('İçerik Tasarımı', 'Content Design'), img: 'https://static.fokusistatistik.com/asistanlar/fokus717.png' },
                  { code: 'fokus808', name: getText('Sosyal Medya', 'Social Media'), img: 'https://static.fokusistatistik.com/asistanlar/fokus808.png' },
                  { code: 'fokus999', name: getText('Joker Asistan', 'Joker Assistant'), img: 'https://static.fokusistatistik.com/asistanlar/fokus999.png' },
                ].map((assistant) => (
                  <a key={assistant.code} href={`https://asistan.fokusistatistik.com/${assistant.code}/`} className="kvz-assistant-item" target="_blank" rel="noopener noreferrer">
                    <img src={assistant.img} alt={assistant.code.toUpperCase()} />
            ...
            <div className="kvz-section">
              <div className="kvz-stats">
                <div className="kvz-stat-item">
                  ...
                  <div className="kvz-stat-label">{getText('Yıl Deneyim', 'Years Experience')}</div>
                </div>
                <div className="kvz-stat-item">
                  <div className="kvz-stat-number">9</div>
                  <div className="kvz-stat-label">{getText('Sanal Asistan', 'Virtual Assistants')}</div>
                </div>
                <div className="kvz-stat-item">
                  <div className="kvz-stat-number">7/24</div>
                  <div className="kvz-stat-label">{getText('Destek', 'Support')}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="kvz-footer">
            <div className="kvz-social-icons">
              ...
              <a href="mailto:bilgi@fokusistatistik.com" title="E-posta Gönder">
                <img src="https://static.fokusistatistik.com/resimler/eposta.png" alt="E-posta Gönder" />
              </a>
            ...
            <div className="kvz-copyright">
              {getText('© 2025 FOKUS İstatistik Veri Bilimi ve YZ Danışmanlığı', '© 2025 FOKUS Statistics Data Science & AI Consulting')}
            </div>
          </div>
        </div>
        ...
        <div className="kvz-voice-assistant">
          ...
          <div className="kvz-voice-text" dangerouslySetInnerHTML={{ __html: getText('Sesli<br>Asistan', 'Voice<br>Assistant') }} />
        </div>

        <div className={`kvz-voice-modal ${showVoiceModal ? 'show' : ''}`} onClick={(e) => {
          if (e.target === e.currentTarget) closeVoiceModal();
        }}>
          <div className="kvz-voice-modal-content">
            ...
            <div className="kvz-voice-modal-body">
              {showVoiceModal && (
                <iframe src="https://vapi.ai?demo=true&shareKey=803df5c1-1a3a-4c20-a663-aaec4b67293f&assistantId=0f0f02b2-7d79-42fe-b1e7-e5dd12be1262" frameBorder="0" allow="microphone; autoplay; camera" />
              )}
            </div>
          </div>
        </div>
